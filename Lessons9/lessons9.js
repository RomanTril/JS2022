...
//     let div=document.createElement('div');
//     div.innerHTML=`<strong>${coursesAndDurationArrayElement.title}</strong>` + ' ' + coursesAndDurationArrayElement.monthDuration
//     body.appendChild(div);
// }
...
//         console.log('Your age does not meet the requirements!!!');
//     }else {
...
let contentsCell=document.createElement('input');
let button=document.createElement('button');
forms.name='f1';
countString.id='countString';
countCells.id='countCells';
contentsCell.id='contentsCell';
button.id='button';
countString.placeholder='Кількість рядків';
...
form1.onsubmit=function (e){
    e.preventDefault();
    let string=this.countString.value;
